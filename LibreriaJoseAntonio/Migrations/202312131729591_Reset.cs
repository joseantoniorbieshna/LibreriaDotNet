namespace LibreriaJoseAntonio.Migrations
{
    ...
    public partial class Reset : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        IdUser = c.String(),
                        Libro_ISBN = c.String(maxLength: 13),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Libroes", t => t.Libro_ISBN)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ItemCarritoes", "Libro_ISBN", "dbo.Libroes");
            ...
            DropIndex("dbo.ItemCarritoes", new[] { "Libro_ISBN" });
